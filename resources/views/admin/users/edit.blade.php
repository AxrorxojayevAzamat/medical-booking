                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="patronymic" type="text"
                                   ...
                                   value="{{ old('patronymic', isset($user) ? $user->patronymic : '') }}" required
                        ...
                        <div class="form-group">
                            <label for="password-confirm"
                                   class="col-form-label text-md-left">{{ __('Подтвердите пароль') }}</label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="birth_date " type="date" class="form-control" data-inputmask-alias="datetime"
                                       data-inputmask-inputformat="yyyy-mm-dd" data-mask name="birth_date"
                                       value="{{ old('birth_date', isset($user) ? $user->birth_date : '') }}" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" class="form-control @error('gender') is-invalid @enderror" name="gender"
                                    value="{{ old('gender', isset($user) && $user->gender== 1 ? 'selected' : '') }}"
                    ...
                    <div class="card primary">
                        <div class="card-header">
                            ...
                            <a class="btn btn-secondary float-right"
                               href="{{ route('admin.users.additional',$user) }}">{{ __('Изменить/Добавить') }}</a>
                        </div>
                        <!-- /.card-header -->
                ...
                <div class="col-md-6">
                    <div class="card primary">
                        <div class="card-header">
                            ...
                            <a class="btn btn-secondary float-right"
                               href="{!! route('timetables.create',['id'=>$user->id, 'clinic_id'=>1])!!}">{{ __('Изменить/Добавить') }}</a>
                        </div>
                        <!-- /.card-header -->
                ...
                <div class="row no-print">
                    <div class="col-12 ">
                        ...
                        <a class="btn btn-secondary btn-sm float-right"
                           style="margin-right: 5px; href="{{ route("admin.users.index") }}">{{ __('Отменить') }}</a>
                    </div>
                </div>
                <!-- /.row -->
        {{--    <div class="card-body">--}}
