                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.users.store") }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="number" min="0" max="1" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender') }}" required autocomplete="gender" autofocus>
