        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 ">
                <select class="form-control" name="type" id="type" required>
                    <option hidden></option>
                    <option value="0" @if (old('type') == '0') selected="selected" @endif>Частная клиника</option>
                    <option value="1" @if (old('type') == '1') selected="selected" @endif>Государственная поликлиника</option>
                </select>
            </div>
        </div>
