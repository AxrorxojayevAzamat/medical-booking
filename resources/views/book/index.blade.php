            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="strip_list wow fadeIn">
                        ...
                        <?php $average = number_format($doctorValue->rate/($doctorValue->num_of_rates?:1), 1, '.', ''); ?>
                            
                        <span class="rating">Average rating: {{ $average }} <small>({{ $doctorValue->num_of_rates }})</small></span>
