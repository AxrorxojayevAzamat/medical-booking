            ...
            <div class="col-lg-6">
                <div class="radio">
                    <label>
                        ...
                        {{trans('timetable_edit.week')}}
                    </label>
                </div>
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.monday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.tuesday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.wednesday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.thursday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.friday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.saturday')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.sunday')}}</label>
            ...
            <div class="col-lg-6">
                <div class="radio">
                    <label>
                        ...
                        {{trans('timetable_edit.month_even_odd')}}
                    </label>
                </div>

                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.even_day')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.odd_day')}}</label>
    ...
    <div class="card">
        <div class="card-body row">
            <div class="col-lg-6">
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.interval')}}</label>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        <label>{{trans('timetable_edit.lunch_times')}}</label>
