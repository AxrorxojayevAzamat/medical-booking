...
return [
    ...
    'verify_message'              => 'Вам необходимо подтвердить свой аккаунт',
    'verify_email_sent'           => 'На ваш адрес электронной почты отправлена ​​новая ссылка для подтверждения.',
    'verify_check_your_email'     => 'Прежде чем продолжить, проверьте свою электронную почту, чтобы найти ссылку для подтверждения.',
